...
// Agrega credenciales
const client = new MercadoPagoConfig({ accessToken: 'TEST-4369596508297506-102719-f51efeda747e5a06248a5580061d1d0e-1060149965' }); // Reemplaza con tu token real
...
app.post("/create_preference", async (req, res) => {
    try {
        const items = req.body.items; // Aquí estás esperando que items sea un array

        // Aquí puedes agregar una validación para verificar que las cantidades son números
        items.forEach(item => {
