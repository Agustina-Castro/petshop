...
//mp
const mp = new MercadoPago("TEST-1e73ad37-b099-4987-8457-95954b19da36", {
    locale: "es-AR",
});



// Al final de tu archivo JavaScript
document.getElementById("comprar").addEventListener("click", async () => {
    ...
    try {
        ...
        const orderData = productos.map(producto => ({
            ...
            quantity: Number(producto.cantidad), // Asegurarte de que sea un número
            unit_price: Number(producto.precio) // También asegurarte de que el precio sea un número
        }));
